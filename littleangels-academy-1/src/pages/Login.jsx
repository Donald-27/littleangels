...
const LoginPage = () => {
  ...
  const demoCredentials = [
    { 
      ...
      description: 'Headteacher - Full system access',
    ...
    { 
      role: 'accounts', 
      email: 'accounts1@littleangels.com', 
      password: 'accounts123', 
      name: 'John Kamau',
      description: 'Finance & Accounting Management',
      permissions: ['Payments', 'Billing', 'Financial Reports'],
      color: 'from-blue-500 to-cyan-500',
      icon: Users
    },
    { 
      role: 'parent', 
      email: 'parent1@littleangels.com', 
      password: 'parent123', 
      name: 'Mr. Maina',
    ...
    { 
      role: 'driver', 
      email: 'driver1@littleangels.com', 
      password: 'driver123', 
      name: 'James Kiprop',
      description: 'Route navigation and student transport',
